              ...
              @foreach ($data as $menu)
                @php
                  ...
                  if (isAccess('delete', $id_menu, auth()->user()->role_id)) {
                      $deleteButton = '<a class="btn-delete" href="javascript:void(0)" data-id="' . $menu->id . '" data-nama="' . $menu->name . '">Hapus</a>';
                  }
                  $action =
                      '
                              ' .
                    ...
                    @foreach ($menu->menus as $submenu)
                      @php
                        ...
                        if (isAccess('delete', $id, auth()->user()->role_id)) {
                            $deleteButton = '<a class="btn-delete" href="javascript:void(0)" data-id="' . $submenu->id . '" data-nama="' . $submenu->name . '">Hapus</a>';
                        }
                        $action =
                            '
                                      ' .
